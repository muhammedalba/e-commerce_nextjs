    ...
    <header className="header-one">
      ...
      <div className="header-right">
        <div className="action-interactive-area__header" ref={popupRef}>
          {/* Search */}
          <div
            className={`single_action__haeader search-action ${
          ...
          {/* Notification */}
          <div
            className={`single_action__haeader notification ${
          ...
          {/* Language Selector */}
          <div
            className={`single_action__haeader language user_avatar__information ${
