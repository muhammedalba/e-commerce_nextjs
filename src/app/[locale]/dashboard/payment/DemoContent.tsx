    ...
    <div className="body-root-inner">
      ...
      <div className="single-payment">
        ...
        <button
          ...
          className={`rts-btn ${
            enabledMethods.woo ? "btn-success" : "btn-primary"
          }`}
        >
      ...
      <div className="single-payment">
        ...
        <button
          ...
          className={`rts-btn ${
            enabledMethods.paypal ? "btn-success" : "btn-primary"
          }`}
        >
      ...
      <div className="single-payment">
        ...
        <div className="inner-content">
          ...
          <p>
            Take payment in person via BASC. More commonly known as direct
            bank/wire transfer
          </p>
        </div>
        <button
          ...
          className={`rts-btn ${
            enabledMethods.transfer ? "btn-success" : "btn-primary"
          }`}
        >
      ...
      <div className="single-payment">
        ...
        <div className="inner-content">
          <h5>Check Payment</h5>
          <p>
            Take payment in person via Checks. This offline gateway can also be
        ...
        <button
          ...
          className={`rts-btn ${
            enabledMethods.check ? "btn-success" : "btn-primary"
          }`}
        >
      ...
      <div className="single-payment">
        ...
        <div className="inner-content">
          ...
          <p>
            Let your shoppers pay upon delivery - by cash or other methods of
            payment.
          </p>
        </div>
        <button
          ...
          className={`rts-btn ${
            enabledMethods.cash ? "btn-success" : "btn-primary"
          }`}
        >
