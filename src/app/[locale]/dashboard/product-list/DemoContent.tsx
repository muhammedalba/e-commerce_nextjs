  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      const defaultProducts = [
        {
          id: 1,
          name: "Rede Blue Gradient iPhone Case",
          productNo: "#87845",
        ...
        {
          id: 2,
          name: "Green Blue Gradient iPhone Case",
          productNo: "#87845",
          category: "Electronics",
          price: "$120",
          date: "03/02/2022",
        ...
        {
          id: 3,
          name: "Hree Blue Gradient iPhone Case",
          productNo: "#87845",
          category: "Electronics",
          price: "$125",
          date: "03/02/2022",
        ...
        {
          id: 4,
          name: "Kabir Blue Gradient iPhone Case",
          productNo: "#87845",
          category: "Electronics",
          price: "$133",
          date: "03/02/2022",
        ...
        {
          id: 5,
          name: "leer Blue Gradient iPhone Case",
          productNo: "#87845",
          category: "Electronics",
          price: "$132",
          date: "03/02/2022",
      ...
      cell: (row) =>
        editProductId === row.id ? (
          <input
            ...
            onChange={(e) =>
              setEditFormData({ ...editFormData, productNo: e.target.value })
            }
          />
        ) : (
          <p>{row.productNo}</p>
      ...
      cell: (row) => (
        <div style={{ position: "relative" }}>
          <img
            ...
            height={20}
            onClick={() =>
              setActiveDropdown((prev) => (prev === row.id ? null : row.id))
            }
      ...
      <div className="transection">
        ...
        <div className="product-top-filter-area-l">
          <div className="left-area-button-fiulter">
            ...
            <div className="signle-product-single-button">
              <span>
                New Item {products.filter((p) => p.name.includes("New")).length}
              </span>
            </div>
          </div>
