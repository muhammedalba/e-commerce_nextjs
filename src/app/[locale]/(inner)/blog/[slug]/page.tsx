              ...
              <div className="blog-details-area-1">
                ...
                <div className="body-content-blog-details">
                  ...
                  <p className="disc">
                    ...
                    nascetur, ultrices pellentesque magna venenatis diam ac
                    malesuada velit, vitae interdum est condimentum auctor eget
                    mattis egestas. Quisque tortor justo condimentum ultrices
                    lobortis quis, placerat senectus enim tempor in malesuada
                    sodales, aptent suscipit ante maecenas volutpat empus class
                    quis nisi leo aliquet morbi aenean cubilia rutrum aptent
                    ridiculus bibendum.
                  </p>

                  <p className="disc">
                    Et pellentesque venenatis aliquet morbi praesent penatibus
                    justo sem velit blandit, sapien pretium duis suspendisse
                    aliquam accumsan suscipit mauris lacinia, aenean orci magnis
                    consequat montes vivamus habitant torquent nec.
                  </p>
                  <p className="quote">
                  ...
                  {[1, 2, 3].map((_, idx) => (
                    <div className="single-latest-post-area" key={idx}>
                      <a href="#" className="thumbnail">
                        <img
                          src={`/assets/images/blog/thumb/0${idx + 1}.jpg`}
                          alt="thumbnail"
                        />
                      </a>
