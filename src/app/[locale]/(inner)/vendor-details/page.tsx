                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="product-area-add-wrapper bg_image">
                      ...
                      <img
                        src="/assets/images/vendor/01.png"
                        alt=""
                        className="one"
                      />
                      <img
                        src="/assets/images/vendor/02.png"
                        alt=""
                        className="two"
                      />
                    </div>
                ...
                <div className="row g-4 ml-v-dec-m mt--40">
                  <div className="col-lg-4 col-md-6">
                    <div className="single-shopping-card-one tranding-product">
                      <a href="/shop" className="thumbnail-preview">
                        <img
                          src="/assets/images/grocery/08.jpg"
                          alt="grocery"
                        />
                      </a>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-shopping-card-one tranding-product">
                      <a href="/shop" className="thumbnail-preview">
                        <img
                          src="/assets/images/grocery/09.jpg"
                          alt="grocery"
                        />
                      </a>
                      <div className="body-content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-shopping-card-one tranding-product">
                      <a href="/shop" className="thumbnail-preview">
                        <img
                          src="/assets/images/grocery/10.jpg"
                          alt="grocery"
                        />
                      </a>
                      <div className="body-content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-shopping-card-one tranding-product">
                      <a href="/shop" className="thumbnail-preview">
                        <img
                          src="/assets/images/grocery/11.jpg"
                          alt="grocery"
                        />
                      </a>
                      <div className="body-content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-shopping-card-one tranding-product">
                      <a href="/shop" className="thumbnail-preview">
                        <img
                          src="/assets/images/grocery/12.jpg"
                          alt="grocery"
                        />
                      </a>
                      <div className="body-content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-shopping-card-one tranding-product">
                      <a href="/shop" className="thumbnail-preview">
                        <img
                          src="/assets/images/grocery/13.jpg"
                          alt="grocery"
                        />
                      </a>
                      <div className="body-content">
