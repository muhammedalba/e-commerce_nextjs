                ...
                <div className="blog-sidebar-single-wized with-title">
                  ...
                  <div className="instagram-post-main-wrapper">
                    ...
                    <a href="#">
                      <div className="single-instagram-post">
                        <img
                          src="/assets/images/blog/thumb/07.jpg"
                          alt="post"
                        />
                      </div>
                    </a>
                    ...
                    <a href="#">
                      <div className="single-instagram-post">
                        <img
                          src="/assets/images/blog/thumb/08.jpg"
                          alt="post"
                        />
                      </div>
                    </a>
                    ...
                    <a href="#">
                      <div className="single-instagram-post">
                        <img
                          src="/assets/images/blog/thumb/09.jpg"
                          alt="post"
                        />
                      </div>
                    </a>
                    ...
                    <a href="#">
                      <div className="single-instagram-post">
                        <img
                          src="/assets/images/blog/thumb/10.jpg"
                          alt="post"
                        />
                      </div>
                    </a>
                    ...
                    <a href="#">
                      <div className="single-instagram-post">
                        <img
                          src="/assets/images/blog/thumb/11.jpg"
                          alt="post"
                        />
                      </div>
                    </a>
