...
export const supplierSchema = (t: any) =>
  z.object({
    ...
    contactName: z
      .string()
      .min(1, { message: t("Validation.requiredName") })
      .min(10, { message: t("Validation.shortName") })
      .max(500, { message: t("Validation.longName") })
      .optional(),
    ...
    phone: z
      .string()
      .min(1, { message: t("Validation.shortPhone") })
      .max(12, { message: t("Validation.longPhone") }),
    website: z
      .url()
      .min(1, { message: t("Validation.shortWebsite") })
      .max(50, { message: t("Validation.longWebsite") }),
    status: statusEnum,
