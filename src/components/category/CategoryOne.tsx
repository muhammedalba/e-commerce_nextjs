                  ...
                  >
                    <SwiperSlide>
                      <div className="single-category-one">
                        <a href="/shop">
                          <img
                            src="/assets/images/category/01.png"
                            alt="category"
                          />
                    ...
                    <SwiperSlide>
                      <div className="single-category-one">
                        <a href="/shop">
                          <img
                            src="/assets/images/category/02.png"
                            alt="category"
                          />
                          <p>Organic Vegetable</p>
                          <span>299 Items</span>
                    ...
                    <SwiperSlide>
                      <div className="single-category-one">
                        <a href="/shop">
                          <img
                            src="/assets/images/category/05.png"
                            alt="category"
                          />
                          <p>Organic Vegetable</p>
                          <span>299 Items</span>
                    ...
                    <SwiperSlide>
                      <div className="single-category-one">
                        <a href="/shop">
                          <img
                            src="/assets/images/category/06.png"
                            alt="category"
                          />
                          <p>Organic Vegetable</p>
                          <span>299 Items</span>
                    ...
                    <SwiperSlide>
                      <div className="single-category-one">
                        <a href="/shop">
                          <img
                            src="/assets/images/category/07.png"
                            alt="category"
                          />
                          <p>Organic Vegetable</p>
                          <span>299 Items</span>
                    ...
                    <SwiperSlide>
                      <div className="single-category-one">
                        <a href="/shop">
                          <img
                            src="/assets/images/category/08.png"
                            alt="category"
                          />
                          <p>Organic Vegetable</p>
                          <span>299 Items</span>
